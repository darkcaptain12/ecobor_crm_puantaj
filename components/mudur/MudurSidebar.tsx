...
import {
  Leaf, LayoutDashboard, Users, ShoppingCart,
  Package, BarChart2, Bell, LogOut, Menu, X,
} from 'lucide-react';
import { cn } from '@/lib/utils';

const navItems = [
  { href: '/mudur', label: 'Dashboard', icon: LayoutDashboard, exact: true },
  { href: '/mudur/musteriler', label: 'Müşteriler', icon: Users },
  { href: '/mudur/siparisler', label: 'Siparişler', icon: ShoppingCart },
  { href: '/mudur/envanter', label: 'Envanter', icon: Package },
  { href: '/mudur/raporlar', label: 'Raporlar', icon: BarChart2 },
  { href: '/mudur/bildirimler', label: 'Bildirimler', icon: Bell },
];
      ...
      <div className="p-5 border-b border-eco-admin-border">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[10px] text-gray-400">Müdür Paneli</p>
          </div>
        </div>
      </div>
...
export default function MudurSidebar() {
