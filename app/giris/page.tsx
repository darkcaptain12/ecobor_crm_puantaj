    ...
    <div className="min-h-screen bg-eco-bg flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-eco-text">ECOBOR</h1>
          <p className="text-eco-text-2 text-sm mt-1">Tarım CRM & Puantaj Sistemi</p>
        </div>
        ...
        <p className="text-center text-xs text-eco-gray mt-6">
